...
```{r}
#pairs(credit[,2],col=as.numeric(credit$class))
#pairs(credit,credit$class)
...
#Variable Age
featurePlot(x=credit[,2],y=credit[,16],plot="density")
##pairs(credit[,1],col=as.factor(credit$Class))
...
Como la muestra tiene una distribucion desplazada skewed, la mediana es la mejor opcion como valor central para sustituir.
