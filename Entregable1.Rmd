...
seeds[[seedsLength+1]]<-sample.int(1000, 1)
# TrainControl con seeds
credit.Train.Control.gbm <- trainControl(method = "repeatedcv", number = 10, repeats = 3, verboseIter=T, seeds=seeds, returnResamp = "all") # Guardamos todo para hacer diagramas
...
#Ejecutar Modelos
set.seed(1234)
credit.Train.gbm<-train(credit.Datos.Train[credit.Vars.Entrada.Usadas], credit.Datos.Train[[credit.Var.Salida.Usada]], method = 'gbm',trControl = credit.Train.Control.gbm , tuneGrid = credit.Train.gbm.grid, verbose=FALSE)
