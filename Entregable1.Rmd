...
p1<-featurePlot(x=predict(credit.preProc.ClssDtrb.Mod, credit.Datos.Train.Transf.CS.BC[credit.Vars.Entrada.Escaladas]), credit.Datos.Train.Transf.CS.BC[,15],plot="ellipse")

p2<-featurePlot(x=credit.Datos.Train.Transf.CS.BC[credit.Vars.Entrada.Escaladas], credit.Datos.Train.Transf.CS.BC[,15],plot="ellipse")
