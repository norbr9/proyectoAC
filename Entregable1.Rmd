...
set.seed(1234)
credit.Train.rf<-train(credit.Datos.Train[credit.Vars.Entrada.Usadas], credit.Datos.Train[[credit.Var.Salida.Usada]], method='rf', trControl=credit.Train.Control.CV1, tuneLength = 4)
...
Gráfico de la precision del modelo frente a los hiper-parámetros
...
Grafico del valor estadistico Kappa frente a los hiper-parámetros
```{r}
plot(credit.Train.gbm, metric = "Kappa")
```

Grafico de nivel, precision frente a hiper-parámetros.
...
#Modelo RF con tuneLength
set.seed(1234)
credit.Train.rf<-train(credit.Train.Preprocesado[credit.Vars.Entrada.Usadas], credit.Train.Preprocesado[[credit.Var.Salida.Usada]], method='rf', trControl=credit.Train.Control.CV2, tuneLength = 4)
