...
seeds[[seedsLength+1]]<-sample.int(1000, 1)
# TrainControl con seeds
credit.Train.Control.gbm <- trainControl(
...
credit.Train.Control.glm <- trainControl(
    method = "repeatedcv",number = 10
  ,repeats = 3
  ## con 3 repeticiones
  ,verboseIter=F
...
#Ejecutar Modelos
set.seed(1234)
credit.Train.gbm<-train(credit.Datos.Train[credit.Vars.Entrada.Usadas],
           credit.Datos.Train[[credit.Var.Salida.Usada]],
           method = 'gbm',trControl = credit.Train.Control.gbm ,tuneGrid = credit.Train.gbm.grid)


set.seed(1234)
credit.Train.glm<-train(credit.Datos.Train[credit.Vars.Entrada.Usadas],
           credit.Datos.Train[[credit.Var.Salida.Usada]],
           method = 'glm',trControl = credit.Train.Control.glm)
