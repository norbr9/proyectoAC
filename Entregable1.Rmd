...
```{r, warning=FALSE}
#results=hide para que no imprima los train
...
# Hay que crear una semilla ´unica para el modelo final a entrenar.
seeds[[seedsLength+1]]<-sample.int(1000, 1)
# TrainControl con seeds
credit.Train.Control.rpart <- trainControl(method='repeatedcv', number = 10, repeats = 3, index = foldIndexes, seeds=seeds)

cl <- makeCluster(detectCores()-1)
registerDoParallel(cl)

set.seed(1234)
credit.Train.rpart<-train(credit.Train.Preprocesado[credit.Vars.Entrada.Usadas], credit.Train.Preprocesado[[credit.Var.Salida.Usada]], method='rpart', trControl=credit.Train.Control.rpart, tuneLength = 10)
...
seeds[[seedsLength+1]]<-sample.int(1000, 1)
# TrainControl con seeds
credit.Train.Control.rf <- trainControl(method='repeatedcv', number = 10, repeats = 3, index = foldIndexes, seeds=seeds)

cl <- makeCluster(detectCores()-1)
registerDoParallel(cl)

set.seed(1234)
credit.Train.rf<-train(credit.Train.Preprocesado[credit.Vars.Entrada.Usadas], credit.Train.Preprocesado[[credit.Var.Salida.Usada]], method='rf', trControl=credit.Train.Control.rf, tuneLength = 4)
...
seeds[[seedsLength+1]]<-sample.int(1000, 1)
# TrainControl con seeds
credit.Train.Control.rf2 <- trainControl(method='repeatedcv', number = 10, repeats = 3, index = foldIndexes, seeds=seeds)

cl <- makeCluster(detectCores()-1)
registerDoParallel(cl)

set.seed(1234)
credit.Train.rf2<-train(credit.Datos.Train[credit.Vars.Entrada.Usadas], credit.Datos.Train[[credit.Var.Salida.Usada]], method='rf', trControl=credit.Train.Control.rf2, tuneLength = 4)
...
seeds[[seedsLength+1]]<-sample.int(1000, 1)
# TrainControl con seeds
credit.Train.Control.rf3 <- trainControl(method='repeatedcv', number = 10, repeats = 3, index = foldIndexes, seeds=seeds)

cl <- makeCluster(detectCores()-1)
registerDoParallel(cl)

set.seed(1234)
credit.Train.rf3<-train(credit.Datos.Train.Transf.CS.BC[credit.Vars.Entrada.Usadas], credit.Datos.Train.Transf.CS.BC[[credit.Var.Salida.Usada]], method='rf', trControl=credit.Train.Control.rf3, tuneLength = 4)
...
#Ejecutar Modelos
set.seed(1234)
credit.Train.gbm<-train(credit.Datos.Train[credit.Vars.Entrada.Usadas], credit.Datos.Train[[credit.Var.Salida.Usada]], method='gbm', trControl=credit.Train.Control.glm, tuneGrid=credit.Train.gbm.grid, verbose=FALSE)

set.seed(1234)
credit.Train.glm<-train(credit.Datos.Train[credit.Vars.Entrada.Usadas], credit.Datos.Train[[credit.Var.Salida.Usada]], method='glm', trControl = credit.Train.Control.glm)
