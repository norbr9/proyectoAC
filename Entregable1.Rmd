...
```{r}
#library(doParallel) -> necesaria en le momento de hacerlo paralelo
...
credit.TrainCtrl.3cv10.plRF <- trainControl(method='repeatedcv', number = 10, repeats = 3, index = foldIndexes, seeds=seeds) # Para usar ROC necesita calcular las classProbs
