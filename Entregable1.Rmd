...
# en el ejemplo,para random forest, solo se var´ıa por defecto el hiperpar´ametro mtry
...
credit.TrainCtrl.3cv10.plRF <- trainControl(method='repeatedcv', number = 10, repeats = 3, index = foldIndexes, seeds=seeds)
