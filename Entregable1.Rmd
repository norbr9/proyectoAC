...
Gráfico de la precision del modelo frente a los hiper-parametros (Datos Transformados)
```{r}
...
Gráfico de la precision del modelo frente a los hiper-parametros (Datos Sin Transformar)
```{r}
# Incrementamos el número de lineas que muestra print
options(max.print = 10000)
# Usamos escala logaritmica en el eje x
...
Gráfico del valor estadistico Kappa frente a los hiper-parametros (Datos Transformados)
```{r}
plot(credit.Train.gbm.t, metric = "Kappa")
```


Gráfico del valor estadistico Kappa frente a los hiper-parametros (Datos Sin Transformar)
```{r}
...
Gráfico de nivel, precision frente a hiper-parametros (Datos Transformados)

```{r}
plot(credit.Train.gbm.t, plotType = "level")
```

Gráfico de nivel, precision frente a hiper-parametros (Datos Sin Transformar)
